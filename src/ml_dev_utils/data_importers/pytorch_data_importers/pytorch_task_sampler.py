...
from src.ml_dev_utils.data_importers.pytorch_data_importers.pytorch_images_data_set_wrapper import PyTorchImagesDataSetWrapper
...
class PyTorchTaskSampler(Sampler):
    ...
    def __init__(
        self,
        dataset: PyTorchImagesDataSetWrapper,
        n_way: int,
        n_shot: int,
        n_query: int,
        n_tasks: int,
